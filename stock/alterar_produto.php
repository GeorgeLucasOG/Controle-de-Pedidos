            ...
            <div class="grid-x" id="cabecalho">
             ...
             <div class="grid-x">
               ...
               <div class="cell auto"></div>
                ...
                <div class="cell small-12 medium-6 large-6">
                  ...
                  <form action='alterar_produto.php' method='post' class="form-select">
            						<p>Buscar Produto: <input type="text" name="busca" maxlength="50" placeholder="Digite o nome do produto"></p>
               ...
               <div class="cell small-12 medium-5 large-5"  id="form-select">
                     <form method="post" action="../php/stock/alterar-produto-submit.php" class="form-cad">
